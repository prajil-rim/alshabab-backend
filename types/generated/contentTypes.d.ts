...
export interface ApiAboutUsPageAboutUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    awards_section: Schema.Attribute.Component<'blocks.awards-section', false> &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experiences_section: Schema.Attribute.Component<
    ...
    featured_in_section: Schema.Attribute.Component<
      'blocks.featured-in-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    guides_section: Schema.Attribute.Component<'blocks.guides-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    map_section: Schema.Attribute.Component<'blocks.map-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    our_journey_section: Schema.Attribute.Component<
      'blocks.our-journey',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    publishedAt: Schema.Attribute.DateTime;
    purpose: Schema.Attribute.Component<'blocks.info-block', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    section_1: Schema.Attribute.Component<'blocks.about-us-section-1', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogPageBlogPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    blog_list_section: Schema.Attribute.Component<
      'blocks.blogs-list-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    hero: Schema.Attribute.Component<'blocks.blog-hero-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    blog_category: Schema.Attribute.Relation<
      ...
      'api::blog-category.blog-category'
    >;
    blog_summary: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    recommended_blogs: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'>;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    share_socials: Schema.Attribute.Component<'elements.logo-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiConsultationFormConsultationForm
  extends Struct.CollectionTypeSchema {
  collectionName: 'consultation_forms';
  info: {
    description: '';
    displayName: 'Consultation Form';
    pluralName: 'consultation-forms';
    singularName: 'consultation-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::consultation-form.consultation-form'
    > &
      Schema.Attribute.Private;
    origin: Schema.Attribute.String;
...
export interface ApiContactUsPageContactUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    offices_section: Schema.Attribute.Component<
      'blocks.offices-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiDestinationListingPageDestinationListingPage
  extends Struct.SingleTypeSchema {
  collectionName: 'destination_listing_pages';
  info: {
    description: '';
    displayName: 'Destination Listing Page';
    pluralName: 'destination-listing-pages';
    singularName: 'destination-listing-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::destination-listing-page.destination-listing-page'
    >;
...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    attractions_section: Schema.Attribute.Component<
      'blocks.attractions-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deals_section: Schema.Attribute.Component<'blocks.deals-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    experience_section: Schema.Attribute.Component<
    ...
    hero: Schema.Attribute.Component<'blocks.destination-hero-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    package: Schema.Attribute.Relation<'oneToOne', 'api::package.package'>;
    publishedAt: Schema.Attribute.DateTime;
    reels_section: Schema.Attribute.Component<'blocks.reels-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    route_section: Schema.Attribute.Component<'blocks.route-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    info_section: Schema.Attribute.Component<
      'blocks.home-info-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    >;
    package_section: Schema.Attribute.Component<
      'blocks.home-package-section',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    price_range: Schema.Attribute.Component<'elements.labels', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    slides: Schema.Attribute.DynamicZone<['blocks.hero-slide']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    trending_search: Schema.Attribute.Component<'elements.link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    why_us_section: Schema.Attribute.Component<'blocks.why-us-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPackageConsultationFormPackageConsultationForm
  ...
  info: {
    description: '';
    displayName: 'Package Consultation Form';
    pluralName: 'package-consultation-forms';
    singularName: 'package-consultation-form';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::package-consultation-form.package-consultation-form'
    > &
      Schema.Attribute.Private;
    origin: Schema.Attribute.String;
    package: Schema.Attribute.Relation<'oneToOne', 'api::package.package'>;
...
export interface ApiPackageListingPagePackageListingPage
  extends Struct.SingleTypeSchema {
  collectionName: 'package_listing_pages';
  info: {
    description: '';
    displayName: 'Package Listing Page';
    pluralName: 'package-listing-pages';
    singularName: 'package-listing-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::package-listing-page.package-listing-page'
    >;
    packages: Schema.Attribute.Component<'blocks.home-package-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    card_banner: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    hero: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiParentPackageParentPackage
  ...
  attributes: {
    ...
    hero_background_mob: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    > &
      ...
      Schema.Attribute.DefaultTo<'International Tour Packages'>;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.seo', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPartnerSectionPartnerSection
  ...
  attributes: {
    ...
    >;
    partner_logo: Schema.Attribute.Component<'elements.logo', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    policy: Schema.Attribute.Blocks &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTermOfServiceTermOfService extends Struct.SingleTypeSchema {
...
export interface ApiTrendingSearchTrendingSearch
  extends Struct.CollectionTypeSchema {
  collectionName: 'trending_searches';
  info: {
    displayName: 'Trending Search';
    pluralName: 'trending-searches';
    singularName: 'trending-search';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::consultation-form.consultation-form': ApiConsultationFormConsultationForm;
